...
curl_setopt($authcurl,CURLOPT_HTTPHEADER,array($header_type,$header_auth["DoYouHaveImplant"]));
...
$redirect_uri = "https://".$serveraddr."/PublicESI/DoYouHaveImplant/getesi.php"; 
...
if(isset($token_data["access_token"])){
	...
	//이미 등록되어있는지 검사
	$qr="select * from PublicESI_keys where characterid=".$character_data['CharacterID']." and service_type=\"DoYouHaveImplant\" and active>=1";
	...
	if($result->num_rows == 1){
		...
		$qr2= "update PublicESI_keys set refresh_token='".$token_data['refresh_token']."' , access_token=\"".$token_data['access_token']."\" , corpid=".$personal_data["corporation_id"]." where characterid=".$character_data['CharacterID']." and service_type=\"DoYouHaveImplant\" and active>=1;";
	...
	errorlogout("ESI Token Error.Please try later.",$serveraddr."/PublicESI/");
