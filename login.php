...
$esiurl="https://login.eveonline.com/oauth/authorize?response_type=code&redirect_uri=https://".$serveraddr."/PublicESI/DoYouHaveImplant/getesi.php&scope=".$ESI_scope["DoYouHaveImplant"]."&client_id=".$client_id["DoYouHaveImplant"];
